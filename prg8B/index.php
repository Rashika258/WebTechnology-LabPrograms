...
echo "\n\n\n";
echo "The order of the matrix A 
is:" . count($matrix1) . "x" . count($matrix1[0]);
echo "\n";
echo "The order of the matrix B 
is:" . count($matrix2) . "x" . count($matrix2[0]);
echo "\n";
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
$rowCount = count($matrix1); //Provides the rowcount of matrix
$colCount = count($matrix1[0]); //Provides the column count ofmatrix
